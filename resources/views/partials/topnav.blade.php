<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
        <div class="top-left-part"><a class="logo" href="index.html">
                <b><img src="{{asset('images/logo.png')}}" alt="home" style="width: 55px;">
                </b></a></div>
        ...
        <!-- /.dropdown-tasks -->
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user animated flipInY">
                    ...
                    {{--<li role="separator" class="divider"></li>--}}
                    <li><a class="lang" clang="en" href="#"><i class="fa fa-flag-checkered"></i> English</a></li>
                    <li><a class="lang" clang="ar" href="#"><i class="fa fa-flag"></i> Arabic</a></li>
                </ul>
                <!-- /.dropdown-user -->
            </li>

            <li class="dropdown"> <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#">
                    <img src="{{asset('images/profileFilled-50.png')}}" alt="user-img" width="36" class="img-circle">
                    <b class="hidden-xs">{{Auth::user()->username}}</b> </a>
                <ul class="dropdown-menu dropdown-user animated flipInY">
                    {{--<li><a href="#"><i class="ti-user"></i> My Profile</a></li>--}}
                    {{--<li><a href="#"><i class="ti-wallet"></i> My Balance</a></li>--}}
                    {{--<li><a href="#"><i class="ti-email"></i> Inbox</a></li>--}}
            ...
            {{--</li>--}}
            <!-- /.Megamenu -->
            <li class="right-side-toggle"> <a class="waves-effect waves-light" href="{{route('auth.logout')}}"><i class="ti-lock"></i></a></li>
            <!-- /.dropdown -->
        </ul>
    </div>
    <!-- /.navbar-header -->
